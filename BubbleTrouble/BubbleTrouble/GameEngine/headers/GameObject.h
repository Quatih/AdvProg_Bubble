...
enum ObjectType : std::size_t { Object_Spike, Object_Player, Object_Bubble, Object_Explosion, Object_Lives, Object_Lives2, Object_PowerUp, Object_StaticImage, Object_Font, MAX_OBJECTS};
